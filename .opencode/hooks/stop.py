...
def get_completion_messages():
    ...
    return [
        ...
        f"The render for {project_name} is complete, {engineer_name}",
        f"{engineer_name}, {project_name} diagnostics are complete. Looking good",
        f"{engineer_name}, might I say {project_name} turned out rather well",
        f"Test complete for {project_name}, {engineer_name}. Powering down",
    ]
